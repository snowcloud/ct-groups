...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CTGroup.show_resources'
        db.add_column('ct_groups_ctgroup', 'show_resources', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CTGroup.show_resources'
        db.delete_column('ct_groups_ctgroup', 'show_resources')
