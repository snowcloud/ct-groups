...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GroupMembership.status'
        db.add_column('ct_groups_groupmembership', 'status', self.gf('django.db.models.fields.CharField')(default='approved', max_length=8), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupMembership.status'
        db.delete_column('ct_groups_groupmembership', 'status')
    ...
    models = {
        ...
        'ct_groups.groupmembership': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'approved'", 'max_length': '8'}),
