...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Moderation.applicants_text'
        db.add_column('ct_groups_moderation', 'applicants_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Moderation.applicants_text'
        db.delete_column('ct_groups_moderation', 'applicants_text')
