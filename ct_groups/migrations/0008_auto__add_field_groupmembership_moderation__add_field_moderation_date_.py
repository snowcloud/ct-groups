...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ct_groups_groupmembership', 'moderation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ct_groups.Moderation'], null=True, blank=True), keep_default=False)

        # Adding field 'Moderation.date_requested'
        db.add_column('ct_groups_moderation', 'date_requested', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Moderation.status'
        db.add_column('ct_groups_moderation', 'status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=8), keep_default=False)

        # Adding field 'Moderation.moderator'
        db.add_column('ct_groups_moderation', 'moderator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'Moderation.moderation_date'
        db.add_column('ct_groups_moderation', 'moderation_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Moderation.response_text'
        db.add_column('ct_groups_moderation', 'response_text', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GroupMembership.moderation'
        db.delete_column('ct_groups_groupmembership', 'moderation_id')

        # Deleting field 'Moderation.date_requested'
        db.delete_column('ct_groups_moderation', 'date_requested')

        # Deleting field 'Moderation.status'
        db.delete_column('ct_groups_moderation', 'status')

        # Deleting field 'Moderation.moderator'
        db.delete_column('ct_groups_moderation', 'moderator_id')

        # Deleting field 'Moderation.moderation_date'
        db.delete_column('ct_groups_moderation', 'moderation_date')

        # Deleting field 'Moderation.response_text'
        db.delete_column('ct_groups_moderation', 'response_text')
    ...
    models = {
        ...
        'ct_groups.groupmembership': {
            ...
            'moderation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ct_groups.Moderation']", 'null': 'True', 'blank': 'True'}),
