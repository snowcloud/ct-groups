...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CTGroup.resource_comment_order'
        db.add_column('ct_groups_ctgroup', 'resource_comment_order', self.gf('django.db.models.fields.CharField')(default='oldest_top', max_length=12), keep_default=False)

        # Adding field 'CTGroupPermission.delete_permission'
        db.add_column('ct_groups_ctgrouppermission', 'delete_permission', self.gf('django.db.models.fields.CharField')(default='50', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CTGroup.resource_comment_order'
        db.delete_column('ct_groups_ctgroup', 'resource_comment_order')

        # Deleting field 'CTGroupPermission.delete_permission'
        db.delete_column('ct_groups_ctgrouppermission', 'delete_permission')
    ...
    models = {
        ...
        'ct_groups.ctgroup': {
            ...
            'resource_comment_order': ('django.db.models.fields.CharField', [], {'default': "'oldest_top'", 'max_length': '12'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'unique': 'True', 'db_index': 'True'}),
            'tags': ('tagging.fields.TagField', [], {})
        },
