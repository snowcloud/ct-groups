...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CTGroup.language'
        db.add_column('ct_groups_ctgroup', 'language', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CTGroup.language'
        db.delete_column('ct_groups_ctgroup', 'language')
