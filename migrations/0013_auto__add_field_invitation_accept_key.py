...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.accept_key'
        db.add_column('ct_groups_invitation', 'accept_key', self.gf('django.db.models.fields.CharField')(max_length=44, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invitation.accept_key'
        db.delete_column('ct_groups_invitation', 'accept_key')
