...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GroupMembership.moderation'
        db.alter_column('ct_groups_groupmembership', 'moderation_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['ct_groups.Moderation'], unique=True, null=True, blank=True))

        # Adding unique constraint on 'GroupMembership', fields ['moderation']
        db.create_unique('ct_groups_groupmembership', ['moderation_id'])


    def backwards(self, orm):
        
        # Changing field 'GroupMembership.moderation'
        db.alter_column('ct_groups_groupmembership', 'moderation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ct_groups.Moderation'], null=True, blank=True))

        # Removing unique constraint on 'GroupMembership', fields ['moderation']
        db.delete_unique('ct_groups_groupmembership', ['moderation_id'])
