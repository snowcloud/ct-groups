...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invitation.accepted_by'
        db.add_column('ct_groups_invitation', 'accepted_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='accepted_by', blank=True, null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Invitation.accepted_by'
        db.delete_column('ct_groups_invitation', 'accepted_by_id')
