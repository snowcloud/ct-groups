...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GroupMembership.notify_post_updates'
        db.delete_column('ct_groups_groupmembership', 'notify_post_updates')

        # Deleting field 'GroupMembership.notify_tool_updates'
        db.delete_column('ct_groups_groupmembership', 'notify_tool_updates')


    def backwards(self, orm):
        
        # Adding field 'GroupMembership.notify_post_updates'
        db.add_column('ct_groups_groupmembership', 'notify_post_updates', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'GroupMembership.notify_tool_updates'
        db.add_column('ct_groups_groupmembership', 'notify_tool_updates', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
